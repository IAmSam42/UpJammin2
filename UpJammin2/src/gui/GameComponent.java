			...
			public void mouseClicked(MouseEvent arg0) {
				...
				if(map.isPlaceable(map.toGridPoint(arg0.getPoint()))) {
					if(panel.getSelected() == Selected.ArrowTurret) {
						new ArrowTurret(map, 1, map.toPixelPoint(map.toGridPoint(arg0.getPoint())), 500, 1, 60, 1);
						...
						new CannonTurret(map, 1, map.toPixelPoint(map.toGridPoint(arg0.getPoint())), 500, 1, 60, 1);
						//System.out.println(arg0.getPoint());
					} 
				}
			}
